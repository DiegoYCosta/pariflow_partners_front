...
class _ClientCompaniesWorkspaceState extends State<_ClientCompaniesWorkspace> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedItem = data.items.isEmpty ? null : data.items[selectedIndex];
